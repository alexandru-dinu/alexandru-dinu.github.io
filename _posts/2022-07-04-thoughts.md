...
subtitle: Thoughts in no particular order.
layout: default
date: 2022-07-04
keywords: thoughts
published: true
...
- Always, **_always_**, apply what you learn -- don't fall into [tutorial trap](https://dev.to/andrewlundydev/how-to-get-out-of-or-completely-avoid-the-tutorial-trap-m27), it's a subtle form of [procrastination](https://twitter.com/fab_rosato/status/1536751342257164290?s=20&t=2F4ICbjtB1AAPNtlBo9gBQ).
- Spreadsheets are extremely good for aggregating experiment data.
- [`jq`](https://stedolan.github.io/jq/) and [`xsv`](https://github.com/BurntSushi/xsv) are your friends.
